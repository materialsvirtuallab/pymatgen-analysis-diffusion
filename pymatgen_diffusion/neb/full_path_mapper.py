...
class MigrationGraph(MSONable):
    ...
    def __init__(
        ...
        """
        Construct the MigrationGraph object using a potential_field will all mobile sites occupied.
        A potential_field graph is generated by connecting all sites withing max_path_length distance of each other
